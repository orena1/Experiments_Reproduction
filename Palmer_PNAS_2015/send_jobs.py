...
def load_file_and_create_fr_list(path_for_overlap_files, min_fr  , max_fr, spon_fr):
    ...
    overlap_per_gid= pickle.load(open(path_for_overlap_files + '/overlap_dt16p7.p','r'))
    ...
    overlap_matrix = []
    for gid in gids:
        overlap_matrix.append(overlap_per_gid[gid])
    fr_matrix = (array(overlap_matrix)+mul_1)*mul_2*(max_firing_rate-minimal_firing_rate)+1
...
BasePath = '/gpfs/bbp.cscs.ch/home/amsalem/proj2/simulations/ThlInput/Palmer_PNAS_2015/'
experiment = {}
experiment['stim_type'] = 'file'
experiment['stim_dt'] = 16.7
...
gid_to_fr_list,overlap_matrix = load_file_and_create_fr_list(path_for_overlap_files = BasePath +'Data/fish/', min_fr= experiment['minimal_firing_rate'], 
...
BS = experiment['seed']
run_name = 'fish' + '_' + `BS` 
simulation_time = "55:00:00" # real run time
