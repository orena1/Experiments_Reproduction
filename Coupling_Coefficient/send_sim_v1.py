...
exp_name = '2_find_correct_holding'
...
if 'load_g_pas' in settings and settings['load_g_pas'] and not os.path.isfile(settings['load_g_pas']):raise Exception("file load_g_pas does not exist")
