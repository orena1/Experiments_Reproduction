...
if cluster == 'neuron_coreneuron':
    base_dir = '/gpfs/bbp.cscs.ch/project/proj2/Programs/Master_Core_22_9_18/soft'  # 'Master_Core_22_9_18'# Master_Core_15_03_19# use this Master_Core_28_12_18 to record voltage
    partition = 'prod'
    if change_gamma:
...
def set_main_path(BasePath, ca, k, DisableUseDep, Disable_CortoCortical, remove_SK_E2, SSA):
    ...
    if remove_SK_E2==True:
        ...
        txt = txt.replace('sims','sims_No_SK_E2')
...
BasePath = '/gpfs/bbp.cscs.ch/project/proj2/simulations/Max_Fano_Factor/sims'
if change_gamma==False:
    BasePath = BasePath.replace('sims', 'sims_low_gamma')
...
simulation_time = "16:00:00" # real run time
...
experiment['first_stimulus_time']  = 30000
...
Ca_vals = [1.25]
k_vals = [4.0,4.1,4.2,4.3,4.4,4.5,4.6]#,float(5.0)]
                        ...
                        for Disable_CortoCortical in Disable_CortoCorticals:
                            for seed in [1]:
                                for freq_start,freq_end in edge_frequencies:
                                    ...
                                    experiment['frequencies']     = [8000.0,8000.0]
