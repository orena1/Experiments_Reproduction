...
#projection_path = '/gpfs/bbp.cscs.ch/project/proj2/circuits/Thalamic_for_FRA/Mult_cond2_Mult_rp1/'
...
freq_and_time = pickle.load(open('/gpfs/bbp.cscs.ch/home/amsalem/Dropbox/Blue_Brain/Experiments_Reproduction/FRA/freq_seqs_for_plasticity/all_freqs.p','r'))
BasePath = '/gpfs/bbp.cscs.ch/home/amsalem/Dropbox/Blue_Brain/Experiments_Reproduction/FRA/freq_seqs_for_plasticity/all_freq/'
...
if model_folders != '../O1_v5/': raise Exception('Using wrong location file!')
experiment['axons_settings']  = [AxoGidToXY]
raw_input("There is a warning here about FRA, make sure you made enough checks")
if 'SSA' not in BasePath: raise Exception('not setted for FRA yet!')
                    ...
                    for remove_SK_E2 in remove_SK_E2s:
                        for Disable_CortoCortical in Disable_CortoCorticals:
                            for freq_start,freq_end in edge_frequencies:
                                ...
                                experiment['frequencies']     = freq_and_time['freqs']
                                experiment['duration_of_stim']     = freq_and_time['isis']
                                
                                
                                
                                rnd.shuffle(experiment['frequencies'])
                                experiment['simulation_end_time']     = np.cumsum(experiment['duration_of_stim'])
