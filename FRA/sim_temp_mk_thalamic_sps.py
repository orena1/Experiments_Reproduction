...
BasePath = '/gpfs/bbp.cscs.ch/project/proj2/simulations/ThlInput/AudInput28_01_19/test_sptimes/SSA/'
if change_gamma==False:
...
#projection_path = '/gpfs/bbp.cscs.ch/project/proj2/circuits/Thalamic_for_FRA/O1_slice_mc2/Mult_cond2_Mult_rp1_freq6263/'
                        ...
                        for Disable_CortoCortical in Disable_CortoCorticals:
                            for seed in [1]:#,2,3,4]:
                                for freq_start,freq_end in edge_frequencies:
                                    ...
                                    experiment['frequencies']     = 75*list(np.logspace(np.log2(freq_start),np.log2(freq_end),num=55,base=2))
