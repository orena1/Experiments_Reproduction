...
OriginalPath = '/gpfs/bbp.cscs.ch/project/proj2/simulations/Reproducing_Experiments/Xue_Nature_2014/31_01_2017/Ca1p25_K2p5/Run_1/Remove_Minis_False/var_1e_06/'
NewPath = '/gpfs/bbp.cscs.ch/project/proj2/simulations/Reproducing_Experiments/Xue_Nature_2014/31_01_2017/Ca1p25_K2p5/Run_1/Remove_Minis_False/var_1e_06_SEClmaps/'
...
Lgids = Circ.mvddb.select_gids(Neuron.layer==3,Neuron.hyperColumn==2, MType.synapse_class=='EXC')
seed = 15
rand = np.random.RandomState(seed)
net_size = 132
Gids = np.random.choice(Lgids,size=net_size,replace=False)
